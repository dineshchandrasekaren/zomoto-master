...
const Navsm = () => (
    <div className='flex items-center py-3 border px-4 w-full justify-between'>
        ...
        <div className='flex items-center gap-3'>
            <button className='bg-zomato-400 hover:bg-zomato-300 py-2 px-3 text-white rounded-full'>Use App</button>
...
const Navlg = () => (
    <div className='flex items-center justify-between m-auto text-gray-600 w-full p-3'>
        <div className="w-5/6 flex gap-5 items-center">
            ...
            <div style={{ boxShadow: 'rgb(28 28 28 / 8%) 0px 2px 8px' }} className='flex text-light items-center w-9/12 border gap-2 p-2  rounded-lg'>
                <div className='flex items-center gap-1 border-r-2 border-gray-300 pr-1  '>
                    <HiLocationMarker className="text-zomato-300 text-4xl" />
                    <input className='w-full text-sm h-full outline-none'  type="text" placeholder="Pattukottai" />
                ...
                <div className='flex items-center w-10/12 gap-2'>
                    ...
                    <input className="w-full h-full text-sm outline-none" type="text" placeholder="Search for restaurant, cuisine or a dish" />
                </div>
            </div>
        </div>
